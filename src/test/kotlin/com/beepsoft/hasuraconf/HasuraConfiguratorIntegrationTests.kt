...
class HasuraConfiguratorIntegrationTests : IntegrationTestBase() {
...
//		JSONAssert.assertEquals(conf.confJson, snapshot, false)
	...
	fun testActionGenerationWithHibernateActions2() {
		...
		print(actionsJson)
		JSONAssert.assertEquals(
			"""{"actions":[{"definition":{"arguments":[{"name":"args","type":"UserAndCalendarInput!"}],"forward_client_headers":true,"handler":"{{HANDLER_URL}}","kind":"synchronous","output_type":"UserAndCalendarOutput","type":"mutation"},"name":"createUserAndCalendar4"},{"definition":{"arguments":[{"name":"name","type":"String!"},{"name":"description","type":"String!"},{"name":"calendarRoleType","type":"calendar_role_type_enum!"}],"forward_client_headers":true,"handler":"{{HANDLER_URL}}","kind":"synchronous","output_type":"String","type":"mutation"},"name":"createUserAndCalendar"},{"definition":{"arguments":[{"name":"args","type":"UserAndCalendarInput!"}],"forward_client_headers":true,"handler":"{{HANDLER_URL}}","kind":"synchronous","output_type":"[UserAndCalendarOutput5!]","type":"mutation"},"name":"createUserAndCalendar5"},{"definition":{"arguments":[{"name":"args","type":"UserAndCalendarInput!"}],"forward_client_headers":true,"handler":"{{HANDLER_URL}}","kind":"synchronous","output_type":"[String!]","type":"mutation"},"name":"createUserAndCalendar3"}],"custom_types":{"enums":[{"name":"calendar_role_type_enum","values":[{"value":"OWNER"},{"value":"EDITOR"},{"value":"VIEWER"}]}],"input_objects":[{"fields":[{"name":"name","type":"String!"},{"name":"description","type":"String!"},{"name":"isPublic","type":"Boolean!"}],"name":"UserAndCalendarInput"}],"objects":[{"fields":[{"name":"userName","type":"String!"},{"name":"userId","type":"bigint!"},{"name":"automaticCalendarId","type":"bigint!"},{"name":"differentCalendarId","type":"bigint!"}],"name":"UserAndCalendarOutput","relationships":[{"field_mapping":{"automaticCalendarId":"id"},"name":"automaticCalendar","source":"default","remote_table":{"name":"calendar","schema":"public"},"type":"object"},{"field_mapping":{"differentCalendarId":"id"},"name":"otherCalendar","source":"default","remote_table":{"name":"calendar","schema":"public"},"type":"object"}]},{"fields":[{"name":"userName","type":"String!"},{"name":"userId","type":"bigint!"},{"name":"automaticCalendarId","type":"bigint!"},{"name":"differentCalendarId","type":"bigint!"}],"name":"UserAndCalendarOutput5","relationships":[{"field_mapping":{"automaticCalendarId":"id"},"name":"automaticCalendar","source":"default","remote_table":{"name":"calendar","schema":"public"},"type":"object"},{"field_mapping":{"differentCalendarId":"id"},"name":"otherCalendar","source":"default","remote_table":{"name":"calendar","schema":"public"},"type":"object"}]}],"scalars":[{"name":"bigint"}]}}""",
			actionsJson,
			true
		)
	}
	...
	fun testActionGenerationWithHibernateActions3() {
		...
		print(actionsJson)
		JSONAssert.assertEquals(
			"""{"actions":[{"definition":{"arguments":[{"name":"name","type":"String!"},{"name":"description","type":"String!"},{"name":"calendarType","type":"CalendarType!"}],"forward_client_headers":true,"handler":"{{HANDLER_URL}}","kind":"synchronous","output_type":"UserAndCalendar","type":"mutation"},"name":"createUserAndCalendar2"},{"definition":{"arguments":[{"name":"args","type":"UserAndCalendarInput!"}],"forward_client_headers":true,"handler":"{{HANDLER_URL}}","kind":"synchronous","output_type":"String","type":"mutation"},"name":"createUserAndCalendar"}],"custom_types":{"enums":[{"name":"CalendarType","values":[{"value":"PRIVATE"},{"value":"PUBLIC"},{"value":"SHARED"}]}],"input_objects":[{"fields":[{"name":"userName","type":"String!"},{"name":"name","type":"String!"},{"name":"description","type":"String!"}],"name":"UserAndCalendarInput"}],"objects":[{"fields":[{"name":"userName","type":"String"},{"name":"userId","type":"bigint!"},{"name":"calendarId","type":"bigint!"},{"name":"differentCalendarId","type":"bigint!"}],"name":"UserAndCalendar","relationships":[{"field_mapping":{"calendarId":"id"},"name":"calendar","source":"default","remote_table":{"name":"calendar","schema":"public"},"type":"object"},{"field_mapping":{"differentCalendarId":"id"},"name":"otherCalendar","source":"default","remote_table":{"name":"calendar","schema":"public"},"type":"object"}]}],"scalars":[{"name":"bigint"}]}}
""",
			actionsJson,
			true
		)
