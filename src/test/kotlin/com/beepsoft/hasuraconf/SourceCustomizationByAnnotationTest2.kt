...
import com.beepsoft.hasuraconf.model3.Comment2
 ...
 */
@EntityScan(basePackageClasses=[BaseObject::class, Comment2::class])
class SourceCustomizationByAnnotationTest2 : IntegrationTestBase() {
	...
	fun testJsonWithSnapshot() {
		...
		var snapshot = readFileUsingGetResource("/metadata_snapshot4.json")
		...
		snapshot = readFileUsingGetResource("/json_schema_snapshot3.json")
